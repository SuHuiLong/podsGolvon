...
@interface FriendsterHeaderView : UITableViewHeaderFooterView<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
    CGFloat _PICWIDHT;
    CGFloat _PICHEIGTH;
    CGSize contentSize;
