...
//    if (self.originalImage.size.width>self.originalImage.size.height*1.19) {
//        [self.cropImageView setCropSize:CGSizeMake(ScreenHeight/1.19, ScreenHeight)];
//    }else{
//    
//    }
    [self.cropImageView setCropSize:CGSizeMake(ScreenWidth, ScreenWidth*1.19)];
