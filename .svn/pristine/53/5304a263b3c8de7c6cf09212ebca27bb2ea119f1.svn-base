...
@interface FindAceTableViewCell : UITableViewCell
...
@property (strong, nonatomic) UIImageView   *visitImage;         //访问量

@property (strong, nonatomic) UILabel       *visitNum;           //描述
