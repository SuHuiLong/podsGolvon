...
//        CGSize imageSize = CGSizeMake(indicatorImage.size.width, indicatorImage.size.height);
        ...
        indicatorImageView.frame = featureItem.imageFrame;
...
//                imageSize = CGSizeMake(introduceImage.size.width, introduceImage.size.height);
                ...
                UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:featureItem.indicatorImageName]];
                
                imageView.clipsToBounds = YES;
                imageView.contentMode = UIViewContentModeScaleAspectFit;
                introduceView = imageView;
                imageView.frame = featureItem.imageFrame;
            ...
            else
            {
                ...
                introduceLabel.layer.cornerRadius = 3;
                introduceLabel.backgroundColor = [UIColor colorWithWhite:0 alpha:0.38];
                ...
                introduceLabel.frame = featureItem.labelFrame;
