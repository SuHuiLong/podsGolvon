...
-(void)createView{
    ...
    _textView.tag = 101;
    _textView.font = [UIFont systemFontOfSize:kHorizontal(14)];
    _textView.frame = CGRectMake(kWvertical(10), kHvertical(5), ScreenWidth - kWvertical(20), kHvertical(55));
...
//    _changToEmojiBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//    _changToEmojiBtn.frame = self.bounds;
//    [self addSubview:_changToEmojiBtn];
