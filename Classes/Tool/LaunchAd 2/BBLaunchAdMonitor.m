...
//    f.size.height -= 50;
    ...
    showDetailBtn.backgroundColor = BlackColor;
    
    [showDetailBtn addTarget:self action:@selector(clickSkip:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [tap addActionBlock:^(id  _Nonnull sender) {
        [weakself showAdDetail:showDetailBtn];
    }];
