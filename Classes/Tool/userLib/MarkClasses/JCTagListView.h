...
@property (nonatomic, strong) UIColor *tagTextSelectedBackgroundColor;// default: rgb(217,217,217)
...
@property (nonatomic, strong, readonly) NSMutableArray *selectedTagsId;
