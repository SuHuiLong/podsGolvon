...
typedef void (^singleScroBlock)(NSDictionary *indexDict);
typedef void (^changeBLock)(NSDictionary *indexDict);

@interface SingleMatchScrollView : UIView
...
//距标准杆按钮
@property(nonatomic,copy)UIButton  *PolePoorButton;
//推杆-
@property(nonatomic,copy)UIButton  *PuttersReduce;
//推杆+
@property(nonatomic,copy)UIButton  *PuttersAdd;
//总杆-
@property(nonatomic,copy)UIButton  *GrossReduce;
//总杆+
@property(nonatomic,copy)UIButton  *GrossAdd;
//加减符号
@property(nonatomic,copy)UILabel  *ModifiedLabel;
//杆数圆形背景
@property(nonatomic,copy)UIView *RoundView;
//修改数据Block
@property(nonatomic,strong)singleScroBlock  singleScroBlock;
//点击距标准杆
