...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = localColor;
    //[UIColor colorWithRed:(83/255.0) green:(179/255.0) blue:(17/255.0) alpha:1.0];
    self.oKButtonTitleColorDisabled = localColor;
...
- (void)configDefaultImageName {
    self.takePictureImageName = @"PublishCamera";
//    @"takePicture.png";
    self.photoSelImageName = @"PublishAlbumsSelect";
...
//    @"photo_def_photoPickerVc.png";
    ...
    self.photoNumberIconImageName = @"publish_number_icon";
//    @"photo_number_icon.png";
    self.photoOriginSelImageName = @"publish_fullPage_icon";
