...
-(void)createSubview{
    ...
    //举报按钮
    _reportBtn = [Factory createButtonWithFrame:CGRectMake(kWvertical(200), kHvertical(13), kWvertical(60), kWvertical(20)) titleFont:kHvertical(12) textColor:WhiteColor backgroundColor:localColor target:self selector:@selector(createReportView) Title:@"举报"];
    ...
    _turnBtn.frame = CGRectMake(0, 0, kWvertical(200), kHvertical(50));
...
-(void)setDataWithModel:(FriendsterModel *)model{
    ...
    if ([userDefaultId isEqualToString:@"383c8c5baf6b1316b062fceac44572c3"]) {
