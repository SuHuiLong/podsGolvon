...
-(void)requesInterviewData{
    ...
    [self.loadDataManager downloadWithUrl:[NSString stringWithFormat:@"%@findapi.php?findkey=gettypeall",urlHeader120] parameters:parameters complicate:^(BOOL success, id data) {
